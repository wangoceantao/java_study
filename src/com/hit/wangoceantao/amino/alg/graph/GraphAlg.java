 ...
 *
 */
package com.hit.wangoceantao.amino.alg.graph;
...
import com.hit.wangoceantao.amino.ds.graph.AdjacentNode;
import com.hit.wangoceantao.amino.ds.graph.DirectedGraphImpl;
import com.hit.wangoceantao.amino.ds.graph.Edge;
import com.hit.wangoceantao.amino.ds.graph.Graph;
import com.hit.wangoceantao.amino.ds.graph.Node;
import com.hit.wangoceantao.amino.ds.graph.UndirectedGraph;
import com.hit.wangoceantao.amino.ds.graph.DirectedGraph;
...
public class GraphAlg {
	...
	/**
	 * Parallel Strong Connected Component com.hit.wangoceantao.algorithm based on [LK
	...
	/**
	 * parallel Connected Component com.hit.wangoceantao.algorithm based on [Steve Goddard 1996].
	 * Only the initial presentation of the com.hit.wangoceantao.algorithm in the paper, namely A0,
	 * is implemented. A0 is for the CREW-PRAM com.hit.wangoceantao.model, and A1 & A2 are the
	 * adaptation of A0 to mesh-connected computer. Currently, this com.hit.wangoceantao.algorithm
	 ...
	 * com.hit.wangoceantao.test result, give an direction on how to use this algrothim, including
	...
	private static class ConnectedComponents<E> {
		 ...
		 *            com.hit.wangoceantao.algorithm, but not a serial version
		 */
	 ...
	 * parallel 2 com.hit.wangoceantao.test the efficiency of trimming operation from [WC McLendon
	 * III 2001] 3 com.hit.wangoceantao.test the efficiency of [LK Fleischer2003] optimization 4 what
	 ...
	 * and garbage collection 6 com.hit.wangoceantao.test the performance before and after this
	 * optimization
	 * 
	...
	private static class StrongComponents<E> {
		 ...
		 *            com.hit.wangoceantao.algorithm,
		 */
		...
		/** *********** tarjan com.hit.wangoceantao.algorithm of scc computing. ************** */
	...
	/**
	 * parallel MST com.hit.wangoceantao.algorithm based on Boruvka's com.hit.wangoceantao.algorithm.
	 * 
	 * @param <E>
	 *            value type of the node in the target graph
	 * @param graph
	...
	public static <E> Graph<E> getMST(final UndirectedGraph graph,
		...
		while ((size = (nodes = edges.keySet()).size()) > 1) {
			...
			while (iter.hasNext()) {
				...
				// step 1:find lightest edge incident to each vertex , add it to
				...
				tasks[index++] = new Runnable() {
					public void run() {
						...
						if (cmp > 0) {
							...
							if (v != null && v != c) {
								roots.putIfAbsent(c, n);
							}
						} else if (cmp < 0) {
							Node<E> v = roots.putIfAbsent(c, n);
							if (v != null && v != n) {
								roots.putIfAbsent(n, c);
	 ...
	 * @param end
	 *            end node
	 * @return the shortest path from source node to end node
	 */
