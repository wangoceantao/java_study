...
/**
 * This class implements the basic sequential quicksort com.hit.wangoceantao.algorithm. Provides
 * functions to com.hit.wangoceantao.algorithm.sort in both ascending and descending order.
 */
...
public class QuickSorter extends DefaultSorter {
	...
	protected int selectPivot (int[] a, int fromIndex, int toIndex) {
		...
		switch (PIVOT_ALG) {
			...
			// in Bentley & McIlroy, "Engineering a com.hit.wangoceantao.algorithm.sort function"
			case 5:
				if (size > 100) {
