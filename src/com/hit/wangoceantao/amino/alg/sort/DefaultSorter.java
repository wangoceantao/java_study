 ...
 * functions to com.hit.wangoceantao.algorithm.sort by ascending and descending orders.
 */
...
public class DefaultSorter extends AbstractSorter {
	...
	/**
	 * @param <T> data type
	 * @param a is the com.hit.wangoceantao.algorithm.jdk.List of Comparable objects to be sorted in a descending order
	 * @param from is the start index of array to be sorted
	 * @param to is the end index of array to be sorted
	 *
	 */
	...
	/**
	 * @param <T> data type
	 * @param a is a com.hit.wangoceantao.algorithm.jdk.List of Comparable objects to be sorted in an ascending order
	 * @param from is the start index of array to be sorted
	 * @param to is the end index of array to be sorted
	 *
	 */
	...
	/**
	 * @param <T> data type
	 * @param a is a com.hit.wangoceantao.algorithm.jdk.List of Comparable objects to be sorted
	 * @param c is the Comparator
	 * @param from is the start index of array to be sorted
	 * @param to is the end index of array to be sorted
	 *
	...
	public void sortp(int[] p, int[] a, int from, int to) {
		// FIXME: Just a simple bubble com.hit.wangoceantao.algorithm.sort for now to keep it simple
