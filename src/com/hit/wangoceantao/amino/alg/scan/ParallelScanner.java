...
package com.hit.wangoceantao.amino.alg.scan;
...
public class ParallelScanner extends DefaultScanner {
	...
	public ParallelScanner() {
		_numberThreads = com.hit.wangoceantao.amino.Runtime.getMaxAvailableWorkerThreads();
	}
	...
	public int[] findAll(final byte[] a, final byte v, int from, int to) {
		...
		final int numThreads = com.hit.wangoceantao.amino.Runtime.reserveThreads(_numberThreads);
		...
		com.hit.wangoceantao.amino.Runtime.releaseThreads(numThreads);
	 ...
	 *  [...,'x','a']['r','a','r','a','a',...]
	 *  are two neighbouring chunks, and we are searching for the com.hit.wangoceantao.string "ara".
	 *  The correct result would point to the com.hit.wangoceantao.string starting just after the element
	 ...
	 *  start of the last com.hit.wangoceantao.string.  For example, if the com.hit.wangoceantao.string arararara is searched for the
	 *  substring ara, then it should see (ara)r(ara)ra, not any other permutation, such as
	 *  ar(ara)r(ara).  In pathalogical cases, e.g. the search com.hit.wangoceantao.string is something like
	 ...
	 * @param v search byte com.hit.wangoceantao.string
	 * @param endIndex starting index of search backwards.
	 * @return index where a call to findNext would return the next valid search com.hit.wangoceantao.string's index, starting
	...
	private int findPreviousEndIndex(final byte[] srcArray, final byte[] v, int endIndex){
		...
		do {
			...
			// search forward.  Note it is possible that the start of the search com.hit.wangoceantao.string
