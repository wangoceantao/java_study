...
package com.hit.wangoceantao.amino.scheduler.internal;
...
public abstract class AbstractScheduler extends AbstractExecutorService
	...
	/**
	 * 
	 * @return com.hit.wangoceantao.algorithm.jdk.List of remaining work items that have not yet finished running.
	 */
	 ...
	 *            work item to run
	 */
	protected abstract void addWork(Runnable command);
