...
package com.hit.wangoceantao.amino.mcas;
...
class MultiCAS {
    ...
    static boolean mcas(int N, Object[] obj, long[] offset, Object[] e,
        ...
        // System.out.println("before com.hit.wangoceantao.algorithm.sort address");
        // for (int i = 0; i < N; i++) {
        ...
        // System.out.println("after com.hit.wangoceantao.algorithm.sort address");
        // for (int i = 0; i < N; i++) {
        // System.out.println(obj[i] + ":" + ((ObjectID) obj[i]).getID());
        // }
