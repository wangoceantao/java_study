 ...
 * This lock free com.hit.wangoceantao.concurrent dictionary implementation is based on the com.hit.wangoceantao.algorithm
...
public class LockFreeDictionary<K, V> implements Map<K, V> {
	...
	/**
	 * com.hit.wangoceantao.Pair of Node.
	 * @param <K> type of key in dictionary
	 * @param <V> type of value in dictionary
	 */
