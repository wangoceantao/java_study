...
package com.hit.wangoceantao.amino.ds.lockfree;
...
import com.hit.wangoceantao.amino.ds.Deque;
import com.hit.wangoceantao.amino.utility.AdaptEliminationArray;
import com.hit.wangoceantao.amino.utility.EliminationArray;
import com.hit.wangoceantao.amino.utility.IEliminationArray;

/**
 * This Deque implementation is based on the com.hit.wangoceantao.algorithm defined in the follwoing
...
public class EBDeque<E> extends AbstractQueue<E> implements Deque<E> {
	...
	/* (non-Javadoc)
	 * @see com.hit.wangoceantao.amino.ds.Deque#getLast()
	 */
	/**
	  * {@inheritDoc}
	  */
