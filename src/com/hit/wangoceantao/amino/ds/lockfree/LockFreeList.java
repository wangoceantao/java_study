...
/**
 *
 * This implementation employs an efficient &quot;lock-free&quot; com.hit.wangoceantao.algorithm
 * based on one described in <a
 * href="http://www.research.ibm.com/people/m/michael/spaa-2002.pdf"> High
 * Performance Dynamic Lock-Free Hash Tables and com.hit.wangoceantao.algorithm.jdk.List-Based Sets</a> by Maged
 * M. Michael.
 *
 * <p>
...
public class LockFreeList<E> extends AbstractSequentialList<E> implements
     ...
     * (non-Javadoc)
     *
     * @see java.util.com.hit.wangoceantao.algorithm.jdk.List#isEmpty()
     */
