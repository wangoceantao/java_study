...
import com.hit.wangoceantao.algorithm.Stack;
...
//        mergeTest();
    ...
    private static void circleTest() {
        ...
        linkList.add(3);
        linkList.add(4);
        System.out.println("circle com.hit.wangoceantao.test source");
        printLinkList(linkList);
        System.out.println("circle com.hit.wangoceantao.test result");
